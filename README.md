...
### !!! 翻墙注意：不要用国内邮箱手机等注册账号，不要填写敏感信息，不要使用国内浏览器和手机自带浏览器，请用不在国内运营浏览器，如`waterfox`、`tor`等，推荐使用`tor(洋葱)浏览器`!!!
### 机场软件我自己比较喜欢[karing.app](karing.app)，比较喜欢的点是，同时支持clash/v2ray/ss订阅，可以从多个机场中自动选出最优线路。不像clash那样要手动选机场。

#### 请按照机场《网站教程》《推荐软件》使用，不建议随意使用某些商店版本。若有其他问题，可在各机场的飞机群提问。
