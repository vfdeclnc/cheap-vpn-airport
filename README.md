...
---
## 往下看有机场列表，可以对比一下，如果没有翻墙经验，希望能认真看完。考虑清楚再买。
### !!! 翻墙注意 !!!：不要用国内邮箱注册账号，不要填写敏感信息，如果是国内手机如果可以请设置任何人不可见，不要使用国内浏览器和手机自带浏览器，请用不在国内运营浏览器，如`waterfox`、`tor`等，推荐使用`tor(洋葱)浏览器`
### 请知晓：很多机场主肉身国内，所以都有跑路的风险。也没有任何翻墙工具是绝对安全的。

#### 机场软件我自己比较喜欢[karing.app](https://karing.app)，比较喜欢的点是，同时支持clash/v2ray/ss订阅，可以从多个机场中自动选出最优线路。不像clash那样要手动选机场。
#### 如有任何问题，可在各机场或者机场软件的电报群提问。
...
|2023.07.01|[**蜂窝云**](https://api.fwcloud.life/auth/register?code=yBPSeL)| ss、vmess |**10 ￥ / 月 / 300 GB**|**22 ￥ / 不限时 / 200 GB**|延迟低，兼顾速度与价格，套餐分类：VIP2-4，VIP5-6，SVIP，<br>节点分类：国外、其他、telegram、youtube、netflix、国外媒体、openAI、Epic、苹果服务等|
|2023.03.09|[**亏本机场**](https://xn--7kq24s4ynvb.site/#/register?code=Lhpm2QMs)| hy2、vless |**1.99 ￥ / 月 / 500 GB**|**9.9 ￥ / 不限时 / 1234 GB**|延迟较低，高性价比|
...
|2023.04.05|[**高速机场**](https://xn--mes358al14ay7i.site/#/register?code=A42GZudh)| vless |**1.9 ￥ / 月 / 500 GB**|**14.9 ￥ / 不限时 / 1000 GB**|延迟一般，节点不多，大部分是美国节点|
